...
def train_network(image_pair):
    ...
    with tf.variable_scope('predict_flow5'):
        predict_flowconf5 = convrelu2(name='conv5_flow', inputs=conv5_flow, filters=24, kernel_size=3, stride=1)
    ...
    with tf.variable_scope('predict_flow2'):
        predict_flowconf2 = convrelu2(name='final_prediction',inputs=concat2, filters=24, kernel_size=3, stride=1)
